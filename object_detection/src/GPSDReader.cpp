// Source: https://github.com/stereolabs/zed-sdk/blob/master/global%20localization/live/cpp/src/gnss_reader/GPSDReader.cpp
...
void GPSDReader::initialize() {
    ...
    // TODO this will hold until you recieve a fix
    while (!received_fix) {
...
sl::GNSSData GPSDReader::getNextGNSSValue() {
    ...
    if (gpsd_data->fix.mode >= MODE_2D) {
        ...
        int gpsd_status = gpsd_data->status;
